...
class Task(ATask):
    ...
    def run(self):
        ...
        #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        # self.severities_of_disease.remove('Средней тяжести')
        #!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        for severity in self.severities_of_disease:
            ...
            if self.operation == operations.AvoidanceOverfitting.value:
    ...
    def _count_all_operations_in_circle(self, learning, severity):
        ...
        current_metrics = learning.count_metrics_for_all_parameters(severity, allow_incomplete_bunch_of_files=False, silently=False) 
