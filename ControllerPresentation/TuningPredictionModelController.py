...
from Entires.Enums import AnalysisTypes, OperationsOfMachineLearning, TypesOfMachineLearningModel, get_values_enum, ResultOperationOfMachineLearning
...
class Controller(AController):
    ...
    def get_possible_values_parameters(self):
        ...
        parameters['Type of model']     = get_values_enum(TypesOfMachineLearningModel)
    ...
    def set_parameters(self, parameters):
        ...
        self.model_type     = parameters['Type of model']
    ...
    def perform_task(self):
        return Initialization.ibusiness.tuning_prediction_model(self.signal_message, self.analysis_type, self.operation, self.model_type, self.severity_of_disease, self.print_only_final_results)
