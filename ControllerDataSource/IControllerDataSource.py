...
from .ConvertedData import ConvertedData
from .ConverterCsvToHdf5 import ConverterCsvToHdf5
...
class IControllerDataSourse(AControllerDataSourse):
    ...
    def read_converted_data(self, signal_message, columns=None, selections=Selections(), ignore_empty_values=True):
        ...
        controller = ConvertedData(signal_message, columns, selections, ignore_empty_values)
