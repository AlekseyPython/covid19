...
class GradientSearch:
    def __init__(self, counted_func, compare_metric, silently=True, shuffle=True, quantity_all_bad_steps_before_break=2,  quantity_continuously_steps_on_plateau=3, set_maximum_parameters=False):
        ...
        for multiplier_first_step in range(1, max_lenght_first_step + 1):
            ...
            for direction in [-1, 1]:
                ...
                for point in self._get_points(characteristics, direction, multiplier_first_step):
                    ...
                    elif self.compare_metric(result_for_direction, current_result) == 1:
                        quantity_steps_on_plateau = 0
                        result_for_direction = current_result
                        point_for_direction = point
                ...
                if self.compare_metric(best_result, result_for_direction) == 1:
