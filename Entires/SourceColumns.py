...
AddressOfResidence =            _Column('AddressOfResidence', 'U400')
Region =                        _Column('Region', 'U18')
DateAnalysis =                  _Column('DateAnalysis', 'U10')
CommentOfPhoneTalking =         _Column('CommentOfPhoneTalking', 'U1000')
AddressArrival =                _Column('AddressArrival', 'U400')
...
CommentOfAmbulance =            _Column('CommentOfAmbulance', 'U1000')
...
CommentOfHospitalization =      _Column('CommentOfHospitalization', 'U1000')
...
CommentOfQuarantine =           _Column('CommentOfQuarantine', 'U1000')
...
CommentOfAftercare =            _Column('CommentOfAftercare', 'U1000')
